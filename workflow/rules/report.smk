...
rule multiqc:
    ...
    input:
        ...
        kallisto=expand("results/04.quantification/kallisto/{sample}/run_info.json", sample=SAMPLES)
    output:
    ...
    shell:
        """
        multiqc results/01.raw_qc/ results/02.trimmed_data/ results/04.quantification/kallisto/ results/04.quantification/salmon/ \
