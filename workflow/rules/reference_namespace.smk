...
rule build_import_manifests:
    ...
    input:
        ...
        salmon=expand("results/04.quantification/salmon/{sample}/quant.sf", sample=SAMPLES),
        kallisto=expand("results/04.quantification/kallisto/{sample}/abundance.tsv", sample=SAMPLES),
        stringtie=expand("results/04.quantification/stringtie/{sample}/final/t_data.ctab", sample=SAMPLES)
    output:
