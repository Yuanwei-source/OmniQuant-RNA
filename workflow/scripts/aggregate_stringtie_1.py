...
def read_gene_abundances(sample_dir):
...
def main():
    ...
    for sample_name, gtf_path in samples:
        ...
        gene_counts = aggregate_gene_counts(transcript_counts, gene_ids, sample_name)
        ...
        gene_tpms, gene_fpkms = read_gene_abundances(sample_dir)
