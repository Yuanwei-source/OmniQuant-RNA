...
### 置换检验验证（1,000 次，10,398 共享基因，4 定量器）

- **RRA Bonferroni 校正略偏反保守**：α = 0.05 处 RRA 经验假阳性率为 **8.20%**（95% CI [7.82%, 8.57%]），略高于名义水平 5%
- **真实信号的强富集**：真实数据中 Tier A 基因（4,239 个）的 RRA Score 远低于空模型分布
